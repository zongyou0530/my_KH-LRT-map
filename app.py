...
if os.path.exists(font_path):
    try:
        ...
        .custom-title {{ font-family: 'ZongYouFont' !important; font-size: 52px; color: #a5d6a7; text-align: center; margin-bottom: 5px; white-space: nowrap; }}
        .credit-text {{ font-family: 'ZongYouFont' !important; font-size: 16px; color: #888; text-align: center; margin-bottom: 25px; letter-spacing: 2px; }}
...
with col_info:
    ...
    st.markdown(f'''
        <div style="font-size: 0.8em; color: #666; margin-top:10px;">
            📍 地圖更新：{now.strftime("%H:%M:%S")}<br>
            🕒 站牌更新：{now.strftime("%H:%M:%S")}
        </div>
    ''', unsafe_allow_html=True)
...
<div class="update-box">
    <b>📦 版本更新紀錄 (V16.0)：</b><br>
    • <b>語法修復</b>：解決 STATION_MAP 定義錯誤導致的 App 崩潰。<br>
    • <b>視覺間距</b>：標題與署名距離調整為舒展距離。<br>
    • <b>標籤放大</b>：卡片內綠色標籤文字放大，層次更分明。<br>
    • <b>功能完整</b>：圖例、非營運提醒及留言板完整回歸。
</div>
''', unsafe_allow_html=True)
