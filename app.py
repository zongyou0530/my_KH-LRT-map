...
ALL_STATIONS = {
    ...
    "鼓山": [22.6415, 120.2830], "馬卡道": [22.6493, 120.2858], "台鐵美術館": [22.6533, 120.2864], 
    "內惟藝術中心": [22.6575, 120.2884], "美術館東": [22.6582, 120.2931], "聯合醫院": [22.6579, 120.2965], 
    "龍華國小": [22.6571, 120.2996], "愛河之心": [22.6565, 120.3028], "新上國小": [22.6562, 120.3075], 
...
<style>
    ...
    html, body, [data-testid="stAppViewContainer"], p, div, span, label, .stSelectbox, .stAlert {
...
try:
    ...
    for train in positions:
        ...
        if lat and lon:
            ...
            popup_html = f"""
            <div style="font-family: 'Zen Maru Gothic', sans-serif; width: 140px; line-height: 1.5; font-size: 11pt;">
