...
# 1. 座標終極校準 (針對 11:56 截圖進行偏移補償)
ALL_STATIONS = {
    "籬仔內": [22.5978, 120.3236], "凱旋瑞田": [22.5970, 120.3162], "前鎮之星": [22.5986, 120.3094],
    "凱旋中華": [22.6006, 120.3023], "夢時代": [22.5960, 120.3045], # 下調 0.0001
    "經貿園區": [22.6015, 120.3012], "軟體園區": [22.6062, 120.3013], "高雄展覽館": [22.6105, 120.2995], 
    "旅運中心": [22.6133, 120.2974], "光榮碼頭": [22.6178, 120.2952], "真愛碼頭": [22.6214, 120.2923], 
    "駁二大義": [22.6193, 120.2863], "駁二蓬萊": [22.6202, 120.2809], 
    "哈瑪星": [22.6222, 120.2885], # 下調 0.0003 對齊藍色點
    "壽山公園": [22.6253, 120.2798], "文武聖殿": [22.6300, 120.2790], "鼓山區公所": [22.6373, 120.2797], 
    "鼓山": [22.6415, 120.2830], "馬卡道": [22.6493, 120.2858], 
    "台鐵美術館": [22.6534, 120.2861], # 微調對齊
    "內惟藝術中心": [22.6575, 120.2884], "美術館東": [22.6582, 120.2931], "聯合醫院": [22.6579, 120.2965], 
    "龍華國小": [22.6571, 120.2996], 
    "愛河之心": [22.6565, 120.3028], # 微調對齊
    "新上國小": [22.6562, 120.3075], "灣仔內": [22.6558, 120.3150], "鼎山街": [22.6555, 120.3204], 
    "高雄高工": [22.6528, 120.3255], "樹德家商": [22.6480, 120.3298], "科工館": [22.6425, 120.3324], 
    "聖功醫院": [22.6360, 120.3315], "凱旋公園": [22.6300, 120.3255], "衛生局": [22.6225, 120.3258], 
    "五權國小": [22.6163, 120.3256], "凱旋武昌": [22.6110, 120.3255], "凱旋二聖": [22.6053, 120.3252], 
    "輕軌機廠": [22.6001, 120.3250]
}
...
# 3. 恢復並更新綠色系統提示框
st.success("📢 系統提示：已校準全線座標並套用 Dela 標題 + 圓體內文。 (✅ 目前版本：Dela標題+精準對齊版)")
...
# 顯示綠色站名，加上垂直位移調整(margin-top)，防止錯位
for name, coords in ALL_STATIONS.items():
    if name in CORE_DISPLAY:
        folium.Marker(
            location=coords,
            icon=folium.DivIcon(
                html=f'<div style="font-family: \'Zen Maru Gothic\'; font-size: 15pt; color: #1b5e20; white-space: nowrap; text-shadow: 2px 2px 3px white; font-weight: 700; margin-top: -10px;">{name}</div>'
            )
        ).add_to(m)
